...
namespace KartGame.KartSystems
{
    public class ArcadeKart : MonoBehaviour
    {
        ...
        // Added to support modification by hazards or powerups

        public float topSpeedModifier = 1.0f;
        public float accelerationModifier = 1.0f;
        public bool driftingAllowed = true;
        ...
        void MoveVehicle(bool accelerate, bool brake, float turnInput)
        {
            ...
            // modifiers added by Cara Sterling
            float maxSpeed = localVelDirectionIsFwd ? m_FinalStats.TopSpeed * topSpeedModifier : m_FinalStats.ReverseSpeed;
            float accelPower = accelDirectionIsFwd ? m_FinalStats.Acceleration * accelerationModifier : m_FinalStats.ReverseAcceleration;
            ...
            if (GroundPercent > 0.0f)
            {
                ...
                // Drift Management
                // driftingAllowed added by Cara Sterling to remove drift with hazard 
                if (!IsDrifting && driftingAllowed)
                {
